# Generated by Powerlevel10k configuration wizard on 2024-01-29 at 10:03 EAT.
...
# solid, full frame, dark-ornaments, sparse, many icons, concise, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='%F{red}❟❛❟%f'
